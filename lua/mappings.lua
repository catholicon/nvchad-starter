...
map("n", "<leader>dc", function() require("configs.dap").run_prompt() end,          { desc = "DAP run command (prompt)" })
map("n", "<leader>dl", function() require("configs.dap").run_last() end,            { desc = "DAP re-run last command" })
